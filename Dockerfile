...
RUN rm -rf /home/gsa-user/.m2/repository/com/google/guava/guava/28.2-android/guava-28.2-android.jar
RUN rm -rf /home/gsa-user/.m2/repository/org/apache/maven/shared/maven-shared-utils/3.1.0/maven-shared-utils-3.1.0.jar
